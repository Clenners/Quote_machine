var quotesList = [
    {'quote': 'If you want to achieve greatness stop asking for permission.','author': ''},
    {'quote': 'Things work out best for those who make the best of how things work out.','author': 'John Wooden'},
    {'quote': 'To live a creative life, we must lose our fear of being wrong.','author': ''},
    {'quote': 'If you are not willing to risk the usual you will have to settle for the ordinary.','author': 'Jim Rohn'},
    {'quote': 'Trust because you are willing to accept the risk, not because it\'s safe or certain.','author': ''},
    ...
    {'quote': 'Good things come to people who wait, but better things come to those who go out and get them.','author': ''},
    {'quote': 'If you do what you always did, you will get what you always got.','author': ''},
    ...
    {'quote': 'Successful entrepreneurs are givers and not takers of positive energy.','author': ''},
    ...
    {'quote': 'The ones who are crazy enough to think they can change the world, are the ones that do.','author': ''},
    {'quote': 'Don\'t raise your voice, improve your argument.','author': ''},
    {'quote': 'What seems to us as bitter trials are often blessings in disguise.','author': 'Oscar Wilde'},
    {'quote': 'The meaning of life is to find your gift. The purpose of life is to give it away.','author': ''},
    ...
    {'quote': 'No masterpiece was ever created by a lazy artist.','author': ''},
    ...
    {'quote': 'Do one thing every day that scares you.','author': ''},
    {'quote': 'What\'s the point of being alive if you don\'t at least try to do something remarkable.','author': ''},
    {'quote': 'Life is not about finding yourself. Life is about creating yourself.','author': 'Lolly Daskal'},
    {'quote': 'Nothing in the world is more common than unsuccessful people with talent.','author': ''},
    {'quote': 'Knowledge is being aware of what you can do. Wisdom is knowing when not to do it.','author': ''},
    {'quote': 'Your problem isn\'t the problem. Your reaction is the problem.','author': ''},
    {'quote': 'You can do anything, but not everything.','author': ''},
    ...
    {'quote': 'It\'s not what you look at that matters, it\'s what you see.','author': ''},
    ...
    {'quote': 'Success is...knowing your purpose in life, growing to reach your maximum potential, and sowing seeds that benefit others.','author': 'John C. Maxwel'},
    ...
    {'quote': 'All you have to decide is what to do with the time that is given to you.','author': 'Gandalf'}
];

for (i = 0; i < quotesList.length; i++) {
    if (quotesList[i].author === "") {
        quotesList[i].author = "Unknown";
    }
}
...
document.getElementById("quote-id").innerHTML = quotesList[randNum].quote;
document.getElementById("author-id").innerHTML = quotesList[randNum].author;
